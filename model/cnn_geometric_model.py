...
def featureL2Norm(feature):
    ...
    norm = torch.pow(torch.sum(torch.pow(feature,2),1)+epsilon,0.5).unsqueeze(1).expand_as(feature).contiguous()
...
class GeometricMatching_model(nn.Module):
...
#                 regressor_channels_2 = 64):
        ...
        super(GeometricMatching_model, self).__init__()
