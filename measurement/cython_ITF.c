 ...
 */
      __pyx_t_8 = __pyx_v_i;
      __pyx_t_9 = __pyx_v_j;
      if (__pyx_t_8 < 0) __pyx_t_8 += __pyx_v_img1.shape[0];
      if (__pyx_t_9 < 0) __pyx_t_9 += __pyx_v_img1.shape[1];
      __pyx_t_10 = (((*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_img1.data + __pyx_t_8 * __pyx_v_img1.strides[0]) ) + __pyx_t_9 * __pyx_v_img1.strides[1]) ))) == 0) != 0);
      if (!__pyx_t_10) {
      } else {
      ...
      if (__pyx_t_11 < 0) __pyx_t_11 += __pyx_v_img2.shape[0];
      if (__pyx_t_12 < 0) __pyx_t_12 += __pyx_v_img2.shape[1];
      __pyx_t_10 = (((*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_img2.data + __pyx_t_11 * __pyx_v_img2.strides[0]) ) + __pyx_t_12 * __pyx_v_img2.strides[1]) ))) == 0) != 0);
      __pyx_t_7 = __pyx_t_10;
 ...
 */
      ...
      if (__pyx_t_13 < 0) __pyx_t_13 += __pyx_v_img1.shape[0];
      if (__pyx_t_14 < 0) __pyx_t_14 += __pyx_v_img1.shape[1];
      __pyx_t_15 = __pyx_v_i;
      __pyx_t_16 = __pyx_v_j;
      if (__pyx_t_15 < 0) __pyx_t_15 += __pyx_v_img2.shape[0];
      if (__pyx_t_16 < 0) __pyx_t_16 += __pyx_v_img2.shape[1];
      __pyx_t_17 = abs(((*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_img1.data + __pyx_t_13 * __pyx_v_img1.strides[0]) ) + __pyx_t_14 * __pyx_v_img1.strides[1]) ))) - (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_img2.data + __pyx_t_15 * __pyx_v_img2.strides[0]) ) + __pyx_t_16 * __pyx_v_img2.strides[1]) ))))); if (unlikely(__pyx_t_17 == ((int)-1))) __PYX_ERR(0, 43, __pyx_L1_error)
      __pyx_v_total = (__pyx_v_total + pow(((double)__pyx_t_17), 2.0));
      __pyx_L5_continue:;
    }
  }
 ...
 *     return psnr
 */
  __Pyx_GetModuleGlobalName(__pyx_t_19, __pyx_n_s_math); if (unlikely(!__pyx_t_19)) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_19);
  __pyx_t_20 = __Pyx_PyObject_GetAttrStr(__pyx_t_19, __pyx_n_s_log10); if (unlikely(!__pyx_t_20)) __PYX_ERR(0, 45, __pyx_L1_error)
  ...
  __pyx_t_19 = PyFloat_FromDouble((65025.0 / __pyx_v_error)); if (unlikely(!__pyx_t_19)) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_19);
  __pyx_t_21 = NULL;
  ...
  __pyx_t_20 = PyNumber_Multiply(__pyx_int_10, __pyx_t_18); if (unlikely(!__pyx_t_20)) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_20);
  __Pyx_DECREF(__pyx_t_18); __pyx_t_18 = 0;
  __pyx_t_22 = __pyx_PyFloat_AsFloat(__pyx_t_20); if (unlikely((__pyx_t_22 == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_20); __pyx_t_20 = 0;
  __pyx_v_psnr = __pyx_t_22;
...
static PyObject *__pyx_pw_10cython_ITF_1PSNR_cython(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("PSNR_cython (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_img2)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("PSNR_cython", 1, 2, 2, 1); __PYX_ERR(0, 27, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "PSNR_cython") < 0)) __PYX_ERR(0, 27, __pyx_L3_error)
      }
    ...
    __pyx_v_img1 = __Pyx_PyObject_to_MemoryviewSlice_dsds_unsigned_char(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_img1.memview)) __PYX_ERR(0, 27, __pyx_L3_error)
    __pyx_v_img2 = __Pyx_PyObject_to_MemoryviewSlice_dsds_unsigned_char(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_img2.memview)) __PYX_ERR(0, 27, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("PSNR_cython", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 27, __pyx_L3_error)
  __pyx_L3_error:;
...
static PyObject *__pyx_pf_10cython_ITF_PSNR_cython(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_img1, __Pyx_memviewslice __pyx_v_img2) {
  ...
  if (unlikely(!__pyx_v_img1.memview)) { __Pyx_RaiseUnboundLocalError("img1"); __PYX_ERR(0, 27, __pyx_L1_error) }
  if (unlikely(!__pyx_v_img2.memview)) { __Pyx_RaiseUnboundLocalError("img2"); __PYX_ERR(0, 27, __pyx_L1_error) }
  __pyx_t_1 = PyFloat_FromDouble(__pyx_f_10cython_ITF_PSNR_cython(__pyx_v_img1, __pyx_v_img2, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 27, __pyx_L1_error)
